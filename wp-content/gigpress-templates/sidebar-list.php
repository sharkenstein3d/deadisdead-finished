...
<li class="<?php echo $class; ?>">
	<span class="gigpress-sidebar-notes"><?php echo $showdata['notes']; ?></span>
</li>
<li class="<?php echo $class; ?>">
	<?php if($showdata['external_url']) : ?>
		<a class="button more-show-info" href="<?php echo $showdata['external_url']; ?>">More Info</a>
	<?php endif; ?>
	</
</li>
<hr class="sidebar-show-divider">
